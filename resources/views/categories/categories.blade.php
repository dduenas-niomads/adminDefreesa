								...
								<div class="card-body">
									<div class="tab-content">
										...
										<div class="active tab-pane" id="settings">
											{{ Form::open(array('url' => '/categories', 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
								...
								<div class="card-body">
									<div class="tab-content">
										...
										<div class="active tab-pane" id="new">
											{{ Form::open(array('url' => '/categories', 'method' => 'POST', 'enctype' => 'multipart/form-data' )) }}
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">Imagen</label>
...
@section('scripts')
    @include('categories.partials.scripts-categories')
@stop